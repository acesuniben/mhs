      ...
      <div className="container mx-auto px-6 lg:px-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <p className="text-sm font-light leading-5 text-center md:text-left">
            ...
            here,{" "}
            <span className="font-bold">"Engineering Minds Find Support."</span>
          </p>
          <div className="flex gap-4 mt-4">
            <a
              href="https://x.com/acesuniben"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/aces_uniben23"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <div className="text-center md:text-left">
          <h4 className="text-xl font-bold text-turquoiseBlue mb-4">
            Quick Links
          </h4>
          <ul className="space-y-2 text-sm font-light">
            ...
            <li>
              <a href="tel:+2347045478445" className="hover:underline">
                Contact Us
              </a>
            </li>
          </ul>
        ...
        <div className="text-center md:text-left">
          ...
          <div className="space-y-3 text-sm font-light">
            <div className="flex items-center justify-center md:justify-start gap-2">
              ...
              <p>
                Department of Computer Engineering, University of Benin, Edo
                State Nigeria.
              </p>
            </div>
            <div className="flex items-center justify-center md:justify-start gap-2">
              <img src={GmailLogo} alt="Gmail Icon" className="w-5 h-5" />
              <p>Email: acesuniben24@gmail.com</p>
            </div>
            <div className="flex items-center justify-center md:justify-start gap-2">
